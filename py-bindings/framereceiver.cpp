...
#include "../include/farshow/framereceiver.hpp"
#include "cvnp/cvnp.h"
...
void initFrameReceiver(py::module &m){
	...
	py::class_<farshow::FrameContainer>(m, "FrameContainer")
		.def(py::init<unsigned, unsigned, const std::string &, unsigned>(),
			py::arg("id"), py::arg("total_parts"), py::arg("name"), py::arg("frame_size"))
